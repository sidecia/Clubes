 ...
 */
public class JSONAdaptadorNoticias extends BaseAdapter implements ListAdapter {

    final Activity activity;
    public JSONArray jsonArray;
    final String base_url;

    public JSONAdaptadorNoticias(Activity activity, JSONArray jsonArray) {
    ...
    @Override public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            imageLoader.displayImage(base_url + "recursos/img/"+imagenReal, viewHolder.imagenItemNoticias, opciones);
